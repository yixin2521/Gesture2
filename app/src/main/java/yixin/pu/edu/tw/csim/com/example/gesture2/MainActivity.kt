package yixin.pu.edu.tw.csim.com.example.gesture2
...
import yixin.pu.edu.tw.csim.com.example.gesture2.ui.theme.Gesture2Theme
...
class MainActivity : ComponentActivity() {
    ...
    @Composable
    fun PointerEvents() {
        var msg by remember { mutableStateOf("作者：楊子青") }
        Column {
            Text("\n" + msg)
            Box(
                Modifier
